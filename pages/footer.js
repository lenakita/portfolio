...
export default function footer() {
    return(
        <div className="pb-5">
            <footer className="p-4 md:p-6 bg-slate-100 rounded-lg dark:bg-gray-800">
                <p className="pl-2 md:pl-16 text-md md:text-lg text-slate-800 dark:text-slate-200">Resources used</p>
                <ul className="pl-2 md:pl-20 flex flex-col space-y-1 items-left mt-3 text-sm md:text-md text-gray-500 dark:text-gray-400 sm:mt-0">
